...
| CP-24    | Positivo | Tras devolver ese préstamo | Opción 6 | El préstamo devuelto ya **no** aparece                       |     [Captura CP-19](Imagenes/13.png)                   | NE     |
...
| ID       | Tipo     | Precondición                   | Pasos    | Resultado esperado                                                                    | Resultado obtenido | Estado |
| -------- | -------- | ------------------------------ | -------- | ------------------------------------------------------------------------------------- | ------------------ | ------ |
| CP-26 📷 | Positivo | 1 préstamo activo y 1 devuelto | Opción 7 | Aparecen **los dos**, cada uno con su estado y el devuelto con su fecha de devolución |    [Captura CP-19](Imagenes/12.png)                 | NE     |
