...
Grabamos un video por cada evento de Scrum. Están en Google Drive porque pesan demasiado para
subirlos al repositorio. Cada enlace abre la carpeta del evento, y no hace falta iniciar sesión
para verla.

| Evento | Fecha | Quién lo dirige | Enlace |
|---|---|---|---|
...
registrar, prestar, consultar, devolver y eliminar.

Las actas de cada evento están en su carpeta: `02_Sprint_Planning`, `03_Daily_Scrum`,
`05_Sprint_Review` y `06_Retrospectiva`.
